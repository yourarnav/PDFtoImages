...
def create_app_icon():
    ...
    arrow_poly = [(500, 710), (524, 710), (524, 740), (500, 740)]
    draw.text((370, 710), "→ PNG", font=font_sub, fill=(225, 45, 40, 255))

    # Create iconset directory
    iconset_dir = "/Users/arnav/.gemini/antigravity/scratch/pdf-app-build/AppIcon.iconset"
    ...
    icns_path = "/Users/arnav/.gemini/antigravity/scratch/pdf-app-build/AppIcon.icns"
